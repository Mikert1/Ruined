...
weapon.equipment = 1
weapon.sword = {}
weapon.sword.image = love.graphics.newImage("assets/textures/player/cryonium_sword.png")
weapon.sword.slash = {}
...
weapon.bow = {}
-- weapon.bow.image = love.graphics.newImage("assets/textures/player/cryonium_bow.png")
weapon.bow.arrow = {}
weapon.bow.arrow.image = love.graphics.newImage("assets/textures/player/arrow.png")
