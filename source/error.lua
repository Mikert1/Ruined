...
errorm.button.image = love.graphics.newImage("assets/textures/gui/title/button.png")
...
function love.errorhandler(msg)
	...
	local function draw()
        ...
        love.graphics.print(errorm.title, love.graphics.getWidth() / 2 - font:getWidth(errorm.title) / 2 * 1.5, pos, nil, 1.5)
        love.graphics.setColor(0.15, 0.15, 0.15)
		love.graphics.printf(p, love.graphics.getWidth() / 2 - font:getWidth(p) / 2, pos + 40, love.graphics.getWidth() - pos)
        love.graphics.setColor(1, 1, 1)
        love.graphics.print(errorm.help, love.graphics.getWidth() / 2 - font:getWidth(errorm.help) / 2 + 10, pos + 200)
